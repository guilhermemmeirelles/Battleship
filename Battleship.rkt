  ...
  (lambda (x)
    (cond
      [(= currentPlayer 1)(cond
                            ...
                            [(= x 3)(send textarea set-value "Inserted coordinate doesn't align with the ship \n Player 1: \n - type a valid coordinate and press enter to position your cruiser")]
                            [(= x 4)(send textarea set-value "Inserted coordinate doesn't align with the ship \n Player 1: \n -type a valid coordinate and press enter to position your destroyer")]
                ...
                (cond
                  ...
                  [(regexp-match #rx"(A1|B1|C1|D1|A2|B2|C2|D2|A3|B3|C3|D3|A4|B4|C4|D4)" (string-upcase txt))
                        ...
                        [(equal? (vector-ref (vector-ref board1 (- x 1)) y) "C")
                         (cond
                           [(equal? (vector-ref (vector-ref board1 (vector-ref (hash-ref PositionTable (string-upcase txt)) 3)) (vector-ref (hash-ref PositionTable (string-upcase txt)) 2)) 0)
                            ...
                            (set! size 2)
                            (CruiserPosition 3)(draw)(set! error 0)]
                           )]
                        )
                      (println "- x 1 #f"))
                   ...
                   (if(< (+ y 1) 4)
                      ...
                      (println "- x 1 #f"))(if(= error 1)(ErrorMessage 3)(set! error 1))]
               ...
               [(= size 2)
                (cond
                  ...
                  [(regexp-match #rx"(A1|B1|C1|D1|A2|B2|C2|D2|A3|B3|C3|D3|A4|B4|C4|D4)" (string-upcase txt))
                   ...
                   (if(= error 1)(ErrorMessage 3)(set! error 1))
                   ]
                  (else (ErrorMessage 1))
                  )]
               )]
                ...
                (cond
                  ...
                  [(regexp-match #rx"(A1|B1|C1|D1|A2|B2|C2|D2|A3|B3|C3|D3|A4|B4|C4|D4)" (string-upcase txt))
                   ...
                   (if(< (+ y 1) 4)
                    ...
                    (if(= error 1)(ErrorMessage 4)(set! error 1))
                   ]
                  (else (ErrorMessage 2))
                  )]
               )]
